      ...
      >
        <div className="w-[819px] px-4 font-[font-4]">
          <div className="flex flex-col items-center text-center mb-[120px]">
            <h2 className="text-[70.5px] text-[#01A69F] font-[font-8] mb-4">KT휴대폰은 바로 바로샵</h2>
          ...
          <div className="mb-[150px]">
            <label className="text-[80px] block mb-4 pl-[20px]">상담신청 단말기</label>
            <input
              name="device"
              value={form.device}
              onChange={handleInput}
          ...
          <div className="mb-[150px] mt-[150px]">
            <p className="text-[72px] mb-4 text-center">가입유형을 선택해 주세요.</p>
          ...
          <div className="mb-[150px]">
            <p className="text-[72px] mb-4 text-center">단말기 결제방식을<br />선택해 주세요.</p>
            <div className="grid grid-cols-2 gap-4">
              <button
                onClick={() => handleSelect("paymentPeriod", "일시불")}
                className={`col-span-2 border rounded-md py-12 text-[64px] text-center ${
                  isActive("paymentPeriod", "일시불") ? "border-[#FD3941] font-bold text-[#FD3941]" : "border-black text-black"
                }`}
              >
                일시불
              </button>
          ...
          <div className="mb-[150px]">
            <p className="text-[72px] mb-4 text-center">할인방법 (요금/단말)을<br />선택해 주세요.</p>
            <div className="space-y-8">
              ...
              >
                <div className={`text-[88px] font-bold ${isActive("discountType", "단말할인") ? "text-[#FD3941]" : "text-black"}`}>
                  단말할인
                </div>
              ...
              >
                <div className={`text-[88px] font-bold flex justify-center items-center ${isActive("discountType", "요금할인") ? "text-[#FD3941]" : "text-black"}`}>
                  요금할인
          ...
          <div className="mt-20">
            ...
            <button
              ...
              className="mt-20 w-full bg-[#00B7A3] text-white py-8 rounded-md text-[72px] font-[font-8]"
            >
              상담 예약
            </button>
        ...
        <>
          <div className="fixed inset-0 flex justify-center items-center z-[1000] px-4">
            <div className="w-full max-w-[819px] h-[100vh] bg-white rounded-[30px] border-4 border-red-500 overflow-y-auto relative flex flex-col">
              ...
              {/* ⬆️ 상단 sticky 제목 */}
              <div className="sticky top-0 bg-white p-6 border-b z-10">
                <h2 className="text-[20px] font-bold text-[#000000] text-center">바로샵 비밀 지원금 문자 안내 <br />개인정보 수집 및 이용 동의서</h2>
              </div>
