...
const AboutSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <img src="/B1p/b_21.svg" alt="b_21" onLoad={handleImageLoad} className="mx-auto" />
        <div className="mt-[15px]" />
        <img src="/B1p/b_22.svg" alt="b_22" onLoad={handleImageLoad} className="mx-auto" />
        <div className="mt-[47px]" />
        <img src="/B1p/b_23.svg" alt="b_23" onLoad={handleImageLoad} className="mx-auto" />
